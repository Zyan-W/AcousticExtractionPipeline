...
class OfflineReleaseFileTest(unittest.TestCase):
    def test_windows_offline_powershell_launcher_sets_offline_runtime(self):
        ...
        self.assertIn("from mecab import MeCab", script)
        self.assertIn("jamo", script)
        self.assertIn("spacy_pkuseg", script)
        self.assertIn("dragonmapper", script)
        self.assertIn("hanziconv", script)
    ...
    def test_build_script_creates_expected_bundle_assets(self):
        ...
        self.assertIn("hanziconv", script)
        self.assertIn("MFA_ROOT_DIR", script)
        self.assertIn("offline_license_bundle.py", script)
        self.assertIn("offline_manifest.py", script)
        self.assertIn("offline_release_safety.py", script)
        self.assertIn("THIRD_PARTY_LICENSES.md", script)
        self.assertIn("third_party_licenses_manifest.json", script)
    ...
    def test_windows_offline_workflow_uses_windows_runner_and_smoke_test(self):
        ...
        self.assertIn("licenses/THIRD_PARTY_LICENSES.md", workflow)
        self.assertIn("licenses/third_party_licenses_manifest.json", workflow)
